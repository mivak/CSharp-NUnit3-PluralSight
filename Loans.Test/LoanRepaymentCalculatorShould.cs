...
namespace Loans.Test
{
    public class LoanRepaymentCalculatorShould
    {
        ...
        public void CalculateCorrectMonthlyRepayment_Cetralized(decimal principal,
                                                     decimal interestRate,
                                                     int termInYears,
                                                     decimal expectedMonthlyPayment)
        {
        ...
        [Test]
        [TestCaseSource(typeof(MonthlyRepaymentTestDataWithReturn), nameof(MonthlyRepaymentTestData.TestCases))]
